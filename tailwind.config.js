  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        navy: {
          lighter: customColors.navy.lighter,
          light: customColors.navy.light,
          main: customColors.navy.main,
          DEFAULT: customColors.navy.main,
          dark: customColors.navy.dark,
          darker: customColors.navy.darker,
        },
