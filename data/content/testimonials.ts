...
export const testimonials: Testimonial[] = [
  ...
  {
    id: '9',
    name: 'Zach Hassfurder',
    role: 'Google Review',
    location: 'Coppell, TX',
    content: 'We called Coppell Heating and Air for the first time due to an issue with our AC. Danny came out the same day! He was able to quickly diagnose and fix an unusual issue. Danny was super nice and honest - he thought outside the box to fix our problem.',
    rating: 5,
    date: '6 months ago',
    source: 'google',
  },
  {
    id: '10',
    name: 'Dolores Grissom',
    role: 'Google Review',
    location: 'Coppell, TX',
    content: 'We were lucky to have found them when we moved to Coppell about 20 years ago and have never used anyone else since. Always prompt, great communication by email, text and phone. Have an emergency? You better believe they are right on it.',
    rating: 5,
    date: '6 months ago',
    source: 'google',
  },
  {
    ...
    role: 'Google Review',
    location: 'Coppell, TX',
    content: 'Great recent experience getting a new A/C system. Fast efficient and professional installation and clean up. Isaac, Quintan and Marcus were on time, helpful and friendly. House is cool now on both floors. Owners stopped in a few times to check progress.',
    rating: 5,
    date: '7 months ago',
    source: 'google',
  },
  {
    ...
    role: 'Google Review',
    location: 'Coppell, TX',
    content: 'We\'ve been using Coppell H&A for several years and have an annual maintenance contract. Their technicians have always been polite and professional. Danny came out today and cleaned our a/c unit. It had a dead rat in it and was full of leaves. Look how clean it is now!',
    rating: 5,
    date: 'a year ago',
    source: 'google',
  },
