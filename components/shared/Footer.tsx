...
export const Footer = ({ className }: { className?: string }) => {
  return (
    <footer className={`w-full bg-navy-main ${className || ''}`}>
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            ...
            >
              <motion.div variants={fadeInUp}>
                <p className="text-[14px] text-white/60 mb-1">Office Address:</p>
                <a
                  href="https://maps.app.goo.gl/qZeaD2udM7AuEPSVA"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white font-medium hover:text-primary-main transition-colors"
                >
              ...
              <motion.div variants={fadeInUp}>
                <p className="text-[14px] text-white/60 mb-1">Email Address:</p>
                <a
              ...
              <motion.div variants={fadeInUp}>
                <p className="text-[14px] text-white/60 mb-1">Phone Number:</p>
                <a
            ...
            <motion.div
              ...
              className="mt-10"
            >
              <p className="text-[14px] text-white/60 mb-3">Follow Us:</p>
              <div className="flex items-center gap-4">
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-primary-main hover:bg-primary-light rounded-full flex items-center justify-center text-white transition-colors"
                >
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-secondary-main hover:bg-secondary-light rounded-full flex items-center justify-center text-white transition-colors"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-[24px] p-8 lg:p-10"
          >
              ...
              {footerLinks.slice(0, 1).map((column) => (
                column.links.slice(0, 4).map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
                    className="text-white/70 hover:text-primary-main text-[14px] transition-colors"
                  >
                    {link.title}
                  </Link>
                ))
